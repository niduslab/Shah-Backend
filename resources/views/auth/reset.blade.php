...
<head>
    <meta charset="UTF-8">
    <title>Reset Password | NidusCart</title>
            ...
            <div class="card p-4">
                ...
                <div class="card-body">
                    <div>
                        ...
                        <p class="reset-subtitle">Please enter a new password to regain access to your account.</p>
                    </div>
                    @if(session('status'))
                    ...
                    <form method="POST" action="{{ route('admin.password.update') }}">
                        ...
                        <button type="submit" class="btn w-100 btn-sm btn-outline-secondary">Reset Password</button>
                    </form>
                </div>
            </div>
        </div>
