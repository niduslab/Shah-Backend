<section class="content-body p-xl-4 d-none" id="is-connected">
        ...
        <div class="col-lg-10">
            ...
            <div id="vendor-wallet" class="content-section-2" style="display:block;">
                ...
                <div class="card p-2 shadow-sm">
                    <h3 class="my-2">Vendor Wallet Payouts</h3>
            ...
            <div id="vendor-transactions" class="content-section-2 card p-2" style="display:none;">
...
<section class="py-5" id="not-connected">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card shadow-lg border-0">
                    <div class="card-header bg-warning text-center text-white rounded-top">
                        <h4 class="mb-0 text-white">Wallet Not Connected</h4>
                    </div>
                    <div class="card-body text-center">
                        <h2 class="card-title my-4 text-secondary" style="font-size: 24px;">
                            Connect to Your Stripe Wallet
                        </h2>
                        <p class="card-text text-muted mb-4">
                            Seamlessly manage transactions and payments by linking your Stripe wallet. Get started by connecting now.
                        </p>
                        <a href="{{route('admin.connect.wallet')}}" class="btn btn-sm btn-primary btn-lg px-4 py-2" id="connect-stripe-btn">
                            <i class="far fa-credit-card mx-2"></i> Connect with Stripe
                        </a>
                    </div>
                    <div class="card-footer bg-light text-center py-3">
                        <small class="text-muted">Your connection is secure and encrypted.</small>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        let vendorPayouts = user.vendor_payouts || [];
        let vendorTransactions = user.vendor_transactions || [];
        ...
        if(vendorWallet.account_connected){
            ...
            $('#is-connected').removeClass('d-none');
        }
        ...
        document.getElementById('payout-request-form').addEventListener('submit', function (e) {
            ...
            if (vendorWallet.balance == 0 && amount > vendorWallet.balance) {
