...
class PromotionController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'promotion_type' => 'required|in:percentage,fixed_amount,flash_sale,combo_offer,free_delivery',
            'discount_value' => 'required_unless:promotion_type,free_delivery|numeric|min:0',
            'applies_to' => 'required|in:all_products,specific_products,specific_brands,specific_categories',
            'apply_level' => 'nullable|in:product,cart',
        ...
        $promotion = Promotion::create([
            ...
            'apply_level' => $validated['apply_level'] ?? 'product',
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'description' => 'nullable|string',
            'promotion_type' => 'sometimes|in:percentage,fixed_amount,flash_sale,combo_offer,free_delivery',
            'discount_value' => 'nullable|numeric|min:0',
            'applies_to' => 'sometimes|in:all_products,specific_products,specific_brands,specific_categories',
            'apply_level' => 'nullable|in:product,cart',
            'min_purchase_amount' => 'nullable|numeric|min:0',
            'max_discount_amount' => 'nullable|numeric|min:0',
